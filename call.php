...
<body>
    ...
    <div class="container">
        ...
        <div class="container">
            <h3 style="text-align: center; margin-bottom: 40px;">CALL FOR APPLICATIONS</h3>
            <div class="row">
                <div class="col">

                    <div class="card" style="width: 430px;">
                        <div class="card-title">
                            <h4 style="padding-left: 30px; padding-top: 20px;">Upload fund</h4>
                        </div>
                        <div class="card-body">
                            <div class="container" style="width: 400px; padding: 10px;">
                                <form style="color:black !important;" style="width: 300px;" action="upload2.php" class="mb-4" method="POST" enctype="multipart/form-data">
                                    ...
                                    <input type="submit" name="save" class="btn btn-success" value="Upload" style="float: right; width: 100px;">
                ...
                <div class="col">
                    ...
                    <h4 style="color: blue; margin-top: 10px; margin-bottom: 40px;">View Funds</h4>

...
df1 = df[['VSLA', 'Division', 'Location', 'Capacity', 'Average Age group',
       'Status', 'Activity', 'Male', 'Female', 'Meeting Schedule', 'Year',
       'Savings', 'Shareouts', 'Loans Taken ', 'Loan Amount Returned ',
       'Beneficiary']]

#apply label encoder to categorical columns (VSLA, Division, Location, Status, Activity, 'Meeting Schedule','Beneficiary')
...
#predict shareouts
@app.route('/predict-shareouts',methods=['POST'])
